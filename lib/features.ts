...
export const canConnectMoreCalendars = async (
  currentCount: number,
): Promise<boolean> => {
 ...
 */
export const getHostPlan = async (hostClerkId: string): Promise<PlanType> => {
  try {
 ...
 */
export const getHostBookingQuotaStatus = async (
  hostSlug: string,
