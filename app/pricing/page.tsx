            ...
            appearance={{
              elements: {
                ...
                pricingTableCardButton: {
                  ...
                  // Forces Clerk's default gradient/image background to turn off
                  backgroundImage: "none !important",

                  // Locks in the deep dark background and text colors
                  backgroundColor: "#18181b !important",
                  color: "#ffffff !important",
                  border: "none !important",
                  boxShadow: "0 4px 15px rgba(24, 24, 27, 0.2) !important",
                  cursor: "pointer",
